...
<div class="col-12">
 ...
 <form method="post" action="{{ route('product.store') }}" id="myForm" >
  ...
  <!-- end row -->
    ...
    <div class="row mb-3">
        <label for="example-text-input" class="col-sm-2 col-form-label">Cost </label>
        <div class="form-group col-sm-10">
            <input name="unit_price" class="form-control" type="text">
        </div>
    </div>
    <!-- end row -->

    <div class="row mb-3">
        <label for="example-text-input" class="col-sm-2 col-form-label">SRP</label>
        <div class="form-group col-sm-10">
            <input name="srp_price" class="form-control" type="text">
        </div>
    </div>
    <!-- end row -->
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                unit_price: {
                    required : 'Please Select One Unit Price',
                },
                srp_price: {
                    required : 'Please Select One srp_price',
                },
            },
            errorElement : 'span', 
