 ...
 <div class="page-content">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            <a href="javascript:window.print()" class="btn btn-success waves-effect waves-light" style="float:right;"><i class="fa fa-print"></i></a> &nbsp;
                            <a href="{{ route('invoice.pending.list') }}" class="btn btn-info  waves-effect waves-light" style="float:right;">
