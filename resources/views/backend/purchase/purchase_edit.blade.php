        ...
        <div class="row">
            <div class="col-md-4">
                <div class="md-3">
                    ...
                    <input class="form-control example-date-input" name="date" type="date" value="" id="date">
                </div>
            </div>
...
<script id="document-template" type="text/x-handlebars-template">
    ...
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <td>
            <input type="number" class="form-control unit_price text-right" name="srp_price[]" value=""> 
        </td>
