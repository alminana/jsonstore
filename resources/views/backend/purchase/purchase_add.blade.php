        ...
        <div class="col-md-2">
            <div class="md-2">
                <label for="example-text-input" class="form-label">Unit Price</label>
                 <input class="form-control example-date-input" name="unit_price" type="text"  id="unit_price" readonly style="background-color:#ddd" >
            </div>
        </div>
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
        <input type="number" class="form-control unit_price text-right" value="@{{unit_price}}" name="unit_price[]"> 
        ...
        $(document).on("click",".addeventmore", function(){
            ...
            if(date == ''){
                ...
                return false;
                 ...
                 if(payment_date == ''){
                $.notify("payment date Field is Required" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }

                 
                 if(paymentstatus == ''){
                $.notify("Payment status Field is Required" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
