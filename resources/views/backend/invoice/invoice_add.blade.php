...
<div class="col-12">
    ...
    <div class="row">
       ...
       <div class="col-md-3">
        ...
        <div class="col-md-1">
            <div class="md-3">
                <label for="example-text-input" class="form-label">SRP</label>
                 <input class="form-control example-date-input" name="srp_price" type="text"  id="srp_price" readonly style="background-color:#ddd" >
            </div>
        </div>
...
<!--  ---------------------------------- -->
        ...
        <input type="hidden"  name="paid_amount" class="form-control paid_amount" placeholder="Enter Paid Amount" style="display:none;">
            ...
            <div type="hidden" style="display:none"   class="form-group col-md-9">
...
<div class="row new_customer" style="display:none">
    ...
    <div class="form-group col-md-4">
        <input type="text" name="text" id="email" class="form-control" placeholder="Write Senior ID No.">
    </div>
</div>
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
        <input type="number" class="form-control srp_price text-right" readonly name="srp_price[]" value="@{{srp_price}}"> 
    </td>

    <td>
        <input type="date" class="form-control expiration text-right" id="expiration" name="expiration[]" value=""> 
    </td>
        ...
        $(document).on("click",".addeventmore", function(){
            ...
            if(date == ''){
                ...
                return false;
                 ...
                 if(product_id == ''){
                $.notify("Srp Field is Required" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
