...
class InvoiceController extends Controller
{
    ...
    DB::transaction(function() use($request,$invoice){
        if ($invoice->save()) {
           ...
           for ($i=0; $i < $count_category ; $i++) { 
              ...
              $invoice_details->srp_price = $request->srp_price[$i];
              $invoice_details->selling_price = $request->selling_price[$i];
              $invoice_details->expiration = $request->expiration[$i];
    ...
    public function InvoiceApprove($id){
        ...
        return view('backend.invoice.invoice_approve',compact('invoice','setting'));
    ...
    $allData = Invoice::orderBy('date','desc')->orderBy('id','desc')->where('status','1')->get();
       return view('backend.invoice.print_invoice_list',compact('allData','setting','payment'));
    } // End Method
    ...
    public function PrintInvoice($id){
        ...
        $payment = Payment::latest()->get();
        $invoice = Invoice::with('invoice_details')->findOrFail($id);
        return view('backend.pdf.invoice_pdf',compact('invoice','setting','payment'));
